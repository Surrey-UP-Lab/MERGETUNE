...
do
    ...
    MODEL_DIR=output_KgCoOp_COOP_LMC/KgCoOp/train_base/${DATASET}/${LOSS_TYPE}/shots_${SHOTS}_${Clip_WEIGHT}_${W_LMC}/${TRAINER}/${CFG}/seed${SEED}
    DIR=output_KgCoOp_COOP_LMC/KgCoOp/evaluate/test_${SUB}/${COMMON_DIR}
    RESUME_COOP=None
