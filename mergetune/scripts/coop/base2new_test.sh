...
do
    ...
    MODEL_DIR=MERGETUNE/mergetune/output_coop/train_base/${DATASET}/shots_${SHOTS}/${TRAINER}/${CFG}/seed${SEED}
    DIR=MERGETUNE/mergetune/output_coop/evaluate/test_${SUB}/${COMMON_DIR}
